rem global:
:: /**  
:: *   @file XMLdoxFilter_is.bat 
:: *   Enables "*.xml" files documentation (source) in doxygen (win).
...
:: *  @li in input/FILTER_SOURCE_FILES = true.
:: *  @see XMLdoxFilter.bat for no source.
:: *  @see XMLdoxFilter_is.sh for linux version
:: */
rem
::/**
...
C:
CD C:\filters\bin
rem java.exe xmlfilter  xslt\xml2dox.xslt -i %1  > %1out.txt
java.exe xmlfilter  xslt\xml2dox.xslt -i %1  
